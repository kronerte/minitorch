class Module:
    ...
    def named_parameters(self):
        ...
        for (key, value) in self._modules.items():
            child_parameters = value.named_parameters()
            for (child_name, child_value) in child_parameters:
                parameters.append((key + "." + child_name, child_value))
        return parameters
    ...
    def parameters(self):
        ...
        enum_parameters = []
        for (i, elem) in enumerate(named_parameters):
            enum_parameters.append((i, elem))
